...
public class QuickConstructorGenerator : IIncrementalGenerator
{
  ...
  public void Initialize(IncrementalGeneratorInitializationContext context)
  {
    ...
    context.RegisterSourceOutput(model,
      (context, result) =>
      {
        (var constructorDescriptor, var diagnostic) = result;
    ...
    CancellationToken cancel)
  {
    ...
    return new(classSymbol, typeDeclaration);
  }
  ...
  {
    return typeDeclaration is ClassDeclarationSyntax or RecordDeclarationSyntax or StructDeclarationSyntax;
  }

  private class ClassSymbolProcessorComparer : IEqualityComparer<ClassSymbolProcessor?>
  {
    public static ClassSymbolProcessorComparer Default { get; } = new();
